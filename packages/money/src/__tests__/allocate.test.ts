...
describe('allocateProportional', () => {
  ...
  it('handles large values correctly', () => {
    ...
    expect(parts).toEqual([300000000n, 500000000n, 200000000n]);
  });
