 ...
 */
export type Amount<C extends string = string> = bigint & {
  readonly [__amountBrand]: C;
};
 ...
 */
export type Basis<C extends string = string> = bigint & {
  readonly [__basisBrand]: C;
};
 ...
 */
export type Unit = string & { readonly [__unitBrand]: true };
