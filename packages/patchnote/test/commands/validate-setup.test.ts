...
describe('validateSetup', () => {
  ...
  test('should return 0 when all checks pass', async () => {
    ...
    process.env.PATCHNOTE_APP_ID = '123456';
    process.env.PATCHNOTE_APP_PRIVATE_KEY = 'test-key';
    ...
    // Clean up
    delete process.env.PATCHNOTE_APP_ID;
    delete process.env.PATCHNOTE_APP_PRIVATE_KEY;
  });
