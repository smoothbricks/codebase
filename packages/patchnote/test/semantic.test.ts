...
import { detectSemanticCommits, resolveSemanticPrefix, CONVENTIONAL_COMMIT_REGEX } from '../src/semantic.js'
  ...
  describe('resolveSemanticPrefix', () => {
    ...
    test('returns devPrefix when all updates have isDev=true', async () => {
      ...
      const updates: PackageUpdate[] = [
        { name: 'vitest', fromVersion: '1.0.0', toVersion: '2.0.0', updateType: 'major', ecosystem: 'npm', isDev: true },
        { name: '@types/node', fromVersion: '20.0.0', toVersion: '22.0.0', updateType: 'major', ecosystem: 'npm', isDev: true },
      ]
    ...
    test('returns prefix when updates are mixed dev and prod', async () => {
      ...
      const updates: PackageUpdate[] = [
        { name: 'react', fromVersion: '18.0.0', toVersion: '19.0.0', updateType: 'major', ecosystem: 'npm', isDev: false },
        { name: 'vitest', fromVersion: '1.0.0', toVersion: '2.0.0', updateType: 'major', ecosystem: 'npm', isDev: true },
      ]
