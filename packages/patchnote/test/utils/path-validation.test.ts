...
describe('Real-world use cases from patchnote', () => {
  ...
  test('should work with nested package.json in workspace', () => {
    const repoRoot = '/Users/niko/Developer/private';
    const packagePath = 'packages/patchnote/package.json';
    const result = safeResolve(repoRoot, packagePath);
    expect(result).toBe('/Users/niko/Developer/private/packages/patchnote/package.json');
  });
});
